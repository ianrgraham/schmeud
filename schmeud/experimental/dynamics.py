...
I'd like to have a nice API for computing dynamical quantities like the MSD, SISF, Phop, and D2min, T1Events
...
class SISF:
    ...
    def __init__(self, snap: Optional[gsd.hoomd.Snapshot] = None, mode: str = "uniform"):
    ...
    def compute(self, system: SystemLike, k: float, reset: bool = True) -> npt.ArrayLike:
...
class T1Events:
    ...
    def __init__(self):
        ...
        # We could have a few configurable settings, like whether to perform the delaunay triangulation
